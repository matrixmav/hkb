    ...
    public function accessRules() {
        return array(
            array('allow', // allow all users to perform 'index' and 'view' actions
                'actions' => array('index', 'view', 'list', 'transfer', 
                    'autocomplete', 'confirm', 'status'),
                'users' => array('*'),
            ),
...
$userId = 3;
        if (isset($_POST['transfer'])) {
            ...
            if($userObject){
                ...
                $transactionObjuser->gateway_id = 1;//RP transafer
                ...
                $moneyTransfertoObj->fund_type = 1; //RP
...
//            $moneyTransferadmObj->to_user_id = 1; //admin transaction
