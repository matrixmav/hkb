...
function checkLoginTime(){
    $.ajax({
        type: "POST",
        url: "/admin/default/checksessiontime",
        data: {},
        dataType: "json",
...
$access = Yii::app ()->user->getState ( 'access' );
		if ($access == "manager") {
			?>
			<img src="/metronic/assets/img/logo_manager.png" alt="logo"
				class="img-responsive" />
		<?php }else{?>
			<img src="/metronic/assets/img/logo_admin.png" alt="logo"
				class="img-responsive" />
			<?php }?>
		</a>
			<!-- END LOGO -->
			...
			<ul class="nav navbar-nav pull-right">
                ...
                <?php
																if (count ( $adImg )) {
																	foreach ( $adImg as $ky => $lgAdmin ) {
																		$button = explode ( ":", $lgAdmin );
																		?>  
                    <div class="pull-right inlineBlock"
				style="text-align: center; color: #ff0; margin-top: 2px; margin-left: 6px;">
				<img
					src="<?php echo Yii::app()->request->baseUrl."/images/admin/".$button['0']; ?>"><br /><?php echo $button['1'];?>
                    </div>
                    <?php
																	}
																}
		...
		<div class="page-sidebar-wrapper">
			<div class="page-sidebar navbar-collapse collapse">
				...
				if ($access != "manager") {
					...
					if ((in_array ( $hotel_pmenu, $menusections ['psections'] )) || (in_array ( $hotel_pmenu, $menusections ['section_ids'] ))) {
						...
						<li class="<?php echo $activecls;?>"><a href="javascript:;"> <span
							class="leftmenu-hotel"></span> <span class="title"><?php echo Yii::t('translation','Hotels') ?> </span>
					...
					if ((in_array ( $billing_pmenu, $menusections ['psections'] )) || (in_array ( $billing_pmenu, $menusections ['section_ids'] ))) {
						...
						<a href="javascript:;"> <span class="leftmenu-hotel"></span> <span
							class="title"><?php echo Yii::t('translation','Invoice') ?> </span>
							<span class="selected"></span> <span
					...
					if ((in_array ( $reservation_pmenu, $menusections ['psections'] )) || (in_array ( $reservation_pmenu, $menusections ['section_ids'] ))) {
						...
						<a href="javascript:;"> <span class="leftmenu-reservations"></span>
							<span class="title"><?php echo Yii::t('translation','Reservation') ?> </span>
							<span class="selected"></span> <span
					...
					<li
						...
						<a href="javascript:;"> <span class="leftmenu-customer"></span> <span
							class="title"><?php echo Yii::t('translation','Customers') ?> </span>
							<span class="selected"></span> <span
				...
				<li
						...
						<a href="javascript:;"> <span class="leftmenu-customer"></span> <span
							class="title"><?php echo Yii::t('translation','Users') ?> </span>
							<span class="selected"></span> <span
				...
				<li class="<?php echo ($bases_active !== false) ? "active" : '';?>">
					...
					$blog_pmenu = 5;
					if ((in_array ( $blog_pmenu, $menusections ['psections'] )) || (in_array ( $blog_pmenu, $menusections ['section_ids'] ))) {
						// blog/wp-content/themes/twentyfourteen/functions.php
						?>
				<li class="blogs">
					<?php $string="admin"; $username = base64_encode( $string );?>
					<a href="/blog/wp-admin?aduser=<?php echo $username;?>"
						target="_blank"> <span class="leftmenu-bases"></span> <span
							class="title"><?php echo Yii::t('translation','Blog') ?> </span>
							<span class="selected"></span> </span>
					</a>
