...
class CustomerController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','login','signup','forgotpassword','myaccount','myhotels','myreservations','cancelreservation','validateuser','mlogin','cancelconfirm'),
				'users'=>array('*'),
			),
	...
	public function actionlogin()
	{
		...
		$error = "";
		$errmsg="";
		if((isset($_POST['Customer']['telephone'])) || (isset($_POST['Customer']['password']))){
			$telephone = $_POST['Customer']['telephone'];
		...
		$this->render('login',array('model'=>$model,'errmsg'=>$errmsg));
	}
	...
	public function actionMyreservations()
	{
		if(isset(Yii::app()->session['userid']))
		{
			...
			$criteria=new CDbCriteria;
			$criteria->condition = "res_date < '".$todaysdate."' AND customer_id =".Yii::app()->session['userid']." AND reservation_status IN(1)";
			//$criteria->params = [':date1' => $todaysdate];
	        $previousreservations = Reservation::model()->findAll($criteria);
			$criteria1=new CDbCriteria;
			$criteria1->condition = "res_date >= '".$todaysdate."' AND customer_id =".Yii::app()->session['userid']." AND reservation_status IN(0,1,2)";
