        ...
        <table width="980" align="center" cellpadding="0" cellspacing="0" style="border: 12px solid #eeeeee; font-family:arial;font-size: 14px;line-height: 18px;">
            ...
            <tr>
                <td><table width="770" align="center" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><p style="font-size: 14px;"><span style="font-size: 18px;line-height: 25px;font-family: arial;">Your reservation is confirmed !</span><br/>Thank you for booking on dayuse-hotels.com.<br>
                                    <br>
                                </p>
                                ...
                                <p style="margin-top:0px;font-size:14px;line-height: 23px;">Reservation number : <strong><?php echo $reservationObject->nb_reservation; ?></strong><br>
                                    ...
                                    Expected arrival time : <strong>
                                        ...
                                        $arriavalTime = new DateTime($reservationObject->arrival_time);
                                        echo $arriavalTime->format('h:i A'); } else { echo ""; }?></strong></p></td>
                        </tr>
                        <tr>
                                                ...
                                                <tr>
                                                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <td width="436" align="left" valign="top" style="font-size:14px;">$&nbsp; <?php echo $reservationObject->room_price;?></td>
                                                            </tr>
                                                        </table></td>
                                                </tr>
                                            </table></td>
                                    ...
                                    <tr>
                                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="436" align="left" valign="top" style="font-size:14px;font-family:arial;">$&nbsp; <?php echo $reservationOption->equipment_price; ?></td>
                                                </tr>
                                                <?php } ?>
                                            </table></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="436" align="left" valign="top" style="font-size:14px;font-family:arial;"><strong>$ <?php echo ($total+ $reservationObject->room_price)?>.00</strong></td>
                                                </tr>
                                                <tr>
