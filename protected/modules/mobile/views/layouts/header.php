...
<header>
	<div class="wrapper">
    	<a href="/mobile/" class="logo"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/mobile/logo.png" alt=""></a>
        <a href="#" class="menu"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/mobile/menu.png" alt=""></a>
        <a href="tel://<?php echo Yii::app()->params['dayuseContactNumber']; ?>" class="phone"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/mobile/call.png" alt=""></a>
        <ul class="menuList">
