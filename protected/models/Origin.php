...
class Origin extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('slug','default','value'=>$this->name,'setOnEmpty'=>false,'on'=>'insert'),					
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, slug, added_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'originPortals' => array(self::HAS_MANY, 'OriginPortal', 'origin_id'),
		);
	}
