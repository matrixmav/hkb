...
class InvoicePayment extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, hotel_id, bank_id, paid_inv, inv_no, payment_date, payment_ref, payment_type', 'safe'),			
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, hotel_id, bank_id, paid_inv, inv_no, payment_date, payment_ref, payment_type', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
                    ...
                    'invoice' => array(self::BELONGS_TO, 'Invoice', 'inv_no'),
