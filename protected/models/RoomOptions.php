 ...
 */
class RoomOptions extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('price, added_at, updated_at', 'required'),
			array('room_id, equipment_id, currency_id', 'numerical', 'integerOnly'=>true),
			array('price', 'numerical'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, room_id, equipment_id, price, currency_id, added_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
