    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <?php if(Yii::app()->session['userid']!=''){?> <a href="<?php echo Yii::app()->baseUrl; ?>package/domainsearch?package_id=<?php echo $package['id']; ?>"><?php }else{?><a href="<?php echo Yii::app()->baseUrl; ?>user/loginregistration"><?php }?><div class="pricing-item">
