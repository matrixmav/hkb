...
<body>
<?php $this->renderPartial('//layouts/searchheader');?>     
<?php echo $content; ?>    
...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/spritespin.js?ver=<?php echo strtotime("now");?>"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/spritespin_custom.js?ver=<?php echo strtotime("now");?>"></script>
